...
public class Framenotificationsdisplay extends JFrame 
{
	...
	JLabel lblProfile = new JLabel("Notifications");
	
	
	public Framenotificationsdisplay() 
	{
		...
		//Tittle Panel
				...
				lblProfile.setBounds(251, 154, 221, 54);
